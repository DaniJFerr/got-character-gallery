...
export default function Character({ imageUrl, title, family, fullName}){
    return <div data-test="character-card" className="card-container">
        <img data-test="character-image" src={imageUrl} alt={fullName}></img>
        <div data-test="character-body" className="card-body">
        <h1 data-test="character-content">{title} {fullName} of {family} </h1>
        </div>
    </div>
